...
public class KafkaOutboxProducerConfiguration {
    ...
    @Bean
    public ProducerFactory<String, String> aiOutboxKafkaProducerFactory(
    ...
    @Bean
    public KafkaTemplate<String, String> aiOutboxKafkaTemplate(
            @Qualifier("aiOutboxKafkaProducerFactory") ProducerFactory<String, String> producerFactory
    ) {
