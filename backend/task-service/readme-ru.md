...
| Обновление полей задачи | `TASK_UPDATED` |
| Мягкое удаление задачи | `TASK_DELETED` |
...
*   Побочный эффект события: запись `TASK_UPDATED` в `outbox_events`.
...
*   Побочный эффект события: запись `TASK_DELETED` в `outbox_events`.
