...
public class SecurityConfig {
    ...
    private static final String[] AUDIT_ENDPOINTS = {
            "/api/v1/audit", "/api/v1/audit/**"
    };
    private static final String[] AUDIT_AUTHORITIES = {
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, AUDIT_ENDPOINTS).hasAnyAuthority(AUDIT_AUTHORITIES)
