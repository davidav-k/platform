...
public class UserEventConsumer {
    ...
    public UserEventConsumer(ObjectMapper objectMapper, UserAuditEventNormalizer userAuditEventNormalizer,
                             CreateAuditRecordUseCase createAuditRecordUseCase) {
        this.objectMapper = objectMapper;
        this.userAuditEventNormalizer = userAuditEventNormalizer;
