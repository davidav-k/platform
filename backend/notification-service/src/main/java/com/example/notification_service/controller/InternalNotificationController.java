...
public class InternalNotificationController {
    ...
    public InternalNotificationController(CreateSystemNotificationUseCase createSystemNotificationUseCase) {
        this.createSystemNotificationUseCase = createSystemNotificationUseCase;
    }
