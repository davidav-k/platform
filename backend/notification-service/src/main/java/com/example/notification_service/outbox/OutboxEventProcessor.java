...
public class OutboxEventProcessor {
    ...
    public OutboxEventProcessor(OutboxEventRepository outboxEventRepository,
        ...
        this(outboxEventRepository, outboxEventPublisher, properties,
    ...
    private void processClaimedEvent(OutboxEventEntity event) {
        try {
            ...
            log.warn(
                    "Notification outbox event publish failed: eventId={}, eventType={}, aggregateType={}, aggregateId={}, error={}",
                    event.getEventId(), event.getEventType(), event.getAggregateType(),
                    event.getAggregateId(), errorMessage(exception)
            );
        }
    }
