...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        return http
                ...
                .exceptionHandling(exceptions -> exceptions.authenticationEntryPoint(
                        (request, response, authException) -> unauthorized(request.getRequestURI(), response, objectMapper)
                ))
    ...
    private void unauthorized(String path, HttpServletResponse response, ObjectMapper objectMapper)
