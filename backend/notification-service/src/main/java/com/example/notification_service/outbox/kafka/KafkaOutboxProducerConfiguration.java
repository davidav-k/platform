...
public class KafkaOutboxProducerConfiguration {
    ...
    @Bean
    public ProducerFactory<String, String> notificationOutboxKafkaProducerFactory(
    ...
    public KafkaTemplate<String, String> notificationOutboxKafkaTemplate(
            @Qualifier("notificationOutboxKafkaProducerFactory") ProducerFactory<String, String> producerFactory
    ) {
